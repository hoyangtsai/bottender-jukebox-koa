          ...
          contents: [
            {
              ...
              contents: [
                ...
                },
                {
                  type: 'span',
                  text:
                    'Your track has been added to the BrownJukebox playlist 🎶',
                  color: '#191414',
                },
              ],
              wrap: true,
            ...
            contents: [
              {
                type: 'image',
                url:
                  'https://bcrm-i.line-scdn.net/bcrm/uploads/1557539795/public_asset/file/1039/16041313597470536_logo.png',
                align: 'start',
                size: 'xxs',
                flex: 0,
                aspectRatio: '4:3',
          ...
          contents: [
            ...
            },
            {
              ...
              contents: [
                {
                  type: 'button',
                  action: this.generatePostbackButton('Add', {
